...
export const MOCK_PRODUCTS: MockProduct[] = [
  {
    ...
    description: {
      ...
      en: "A square tichel made from pure silk in a delicate ivory shade. The soft, luxurious fabric suits all seasons and offers an elegant, dignified look. Can be tied in multiple styles.",
    },
    priceCents: 28900,
  ...
  },
  {
    ...
    title: { he: "טישל קטיפה קשור מראש — כחול כהה", en: "Navy Velvet Pre-Tied Tichel" },
    description: {
      he: "טישל קטיפה קשור מראש בגוון כחול כהה עמוק. עשיר ומפואר, מתאים במיוחד לשבת ולאירועים. נוח להרכבה ומחזיק לאורך כל היום.",
      en: "A pre-tied velvet tichel in deep navy. Rich and opulent, perfect for Shabbat and events. Easy to wear and stays in place all day.",
    },
    priceCents: 34900,
  ...
  },
  {
    ...
    description: {
      he: "עטיפת ראש מקשמיר רך במיוחד בגוון אבן חמים. תחושה מפנקת ומראה יוקרתי. מתאימה לחורף ולימים קרירים.",
      en: "An incredibly soft cashmere head wrap in warm stone. Luxurious feel and elegant look. Perfect for winter and cooler days.",
    },
    priceCents: 45900,
  ...
  },
  {
    ...
    title: { he: "צעיף פשתן יומיומי — ירוק מרווה", en: "Linen Everyday Scarf — Sage" },
    description: {
      he: "צעיף פשתן קל ונושם בגוון ירוק מרווה. אידיאלי ליומיום ולקיץ. נוח לאורך שעות ומעניק מראה טבעי ורענן.",
      en: "A light and breathable linen scarf in sage green. Ideal for everyday wear and summer. Comfortable for hours with a fresh, natural look.",
    },
    priceCents: 18900,
  ...
  },
  {
    ...
    description: {
      he: "טורבן כותנה אורגנית בגוון טרקוטה חם. קל להרכבה ונוח לשימוש יומיומי. מתאים לכל עונות השנה.",
      en: "An organic cotton turban in warm terracotta. Easy to wear and comfortable for daily use. Suitable for all seasons.",
    },
    priceCents: 14900,
    collectionIds: ["everyday-elegance"],
    isFeatured: false,
  ...
  },
  {
    ...
    title: { he: "עטיפת קטיפה לשבת — בורדו", en: "Shabbat Velvet Wrap — Burgundy" },
    description: {
      he: "עטיפת קטיפה עשירה בגוון בורדו עמוק. מושלמת לשבת ולחגים. העשירות של הקטיפה מעניקה מראה חגיגי ומרשים.",
      en: "A rich velvet wrap in deep burgundy. Perfect for Shabbat and holidays. The velvet richness creates a festive and impressive look.",
    },
    priceCents: 38900,
    collectionIds: ["signature-collection"],
    isFeatured: true,
  ...
  },
  {
    ...
    title: { he: "טישל ג׳רזי מודל — שחור", en: "Modal Jersey Tichel — Black" },
    description: {
      he: "טישל ג׳רזי מודל רך במיוחד בגוון שחור קלאסי. הבד הנושם מתאים לכל יום ולכל מזג אוויר. לא מתקמט ונשמר יפה לאורך זמן.",
      en: "An ultra-soft modal jersey tichel in classic black. The breathable fabric suits every day and weather. Wrinkle-free and stays beautiful.",
    },
    priceCents: 16900,
    collectionIds: ["everyday-elegance"],
    isFeatured: false,
  ...
  },
  {
    ...
    title: { he: "עטיפת שיפון משי — ורוד אבקתי", en: "Silk Chiffon Wrap — Dusty Pink" },
    description: {
      he: "עטיפת שיפון משי קלילה בגוון ורוד אבקתי רומנטי. מושלמת לאירועים ולימי קיץ. הבד השקוף למחצה מעניק מראה חלומי.",
      en: "A light silk chiffon wrap in romantic dusty pink. Perfect for events and summer days. The semi-sheer fabric creates a dreamy look.",
    },
    priceCents: 32900,
  ...
  },
  {
    ...
    title: { he: "קישוט קריסטל לכלות", en: "Bridal Crystal Headpiece" },
    description: {
...
export function getProductsByCollection(collectionId: string): MockProduct[] {
  return MOCK_PRODUCTS.filter((p) => p.collectionIds.includes(collectionId));
}
